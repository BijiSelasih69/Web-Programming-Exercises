<?php
	...
	//bagian yang  bisa dieksekusi ketika pengunjung submit nama
	...
	if (isset($_COOKIE['username'])) {
		...
		//tampilkan jumlah kunjungan anda saat ini = jumlah visit sebelumnya + 1
		echo "<p>Ini kunjungan Anda yang ke-".($_COOKIE['visits'])."</p>";
		//tampilkan datetime kunjungan anda sebelumnya, baca dari cookie
